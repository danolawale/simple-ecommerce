...
class ShipmentTest extends AbstractUnitTestCase
{
    public function test_create(): void
    {
        ...
        $shipment->setShipmentRef('shipment_ref_1');
        $shipment->setLabelUrl('label.png');
        ...
        $this->assertNotNull($this->getEntity(Shipment::class, [
            'shipmentRef' => 'shipment_ref_1',
        ]));
    }
